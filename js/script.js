...
const config = {
    serverInfo: {
        ...
        serverName: "Eclipse Network", /*Server name*/
        serverIp: "eclipze.xyz", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1047115825460555796" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
